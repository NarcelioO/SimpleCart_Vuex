<template>
    <div class="header">
        <div class="header-nav">
            ...
            <div class="cart" :class="this.showCart ? 'cart_active': ''">
                <div class="cart_display">
                    <p>Seu carrinho</p>
                    <span>
                        <button @click="showCart = !showCart">x</button>
                    </span>
                </div>
                    <div  class="cart_item" v-for="products in $store.state.cart">
                        <div class="cart_content">
                                <h3>{{ products.name }}</h3>
                                <h4>{{ products.price }}</h4>
                        </div>

                        <button @click="removeProductCart()">Remover Curso</button>
                    </div>
                <div>
